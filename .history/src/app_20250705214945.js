...
const encuestaFlow = addKeyword(EVENTS.ACTION)
  .addAction(async (ctx, { state, flowDynamic }) => {
    ...
    try {
      ...
      // Si regresa 404, interpretamos que no existe aún => "no iniciado"
    ...
    // ——— Marcar "en progreso" sólo si aún no se hizo —————————
    ...
    // Si ya está “en progreso”, no volvemos a marcar aquí
  ...
  // … sigue tu .addAnswer(…) sin cambios …
